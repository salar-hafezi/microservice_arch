import { Get, JsonController, Put, Param, Delete, Body, OnUndefined, UseBefore, Req, Res } from 'routing-controllers';
import { validateProduct } from '../../business-layer/validator/ProductValidationProcessor';
import { IProductCreateRequest } from '../requests/IProductRequest';
...
import { ExampleMiddleware } from '../../middleware/custom-middleware/ExampleMiddleware';
